...
def main(author): # single preset
    ...
    skipConfigs = [
        ...
        for (
            ...
            freerider_attack_type, malicious_activation_round, malicious_noise,
            malicious_attack_type, dataset, aggregation_rule, data_distribution,
            dirichlet_alpha, run_id
        ) in productVar
    ]
