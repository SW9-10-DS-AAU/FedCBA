...
class AsyncWriter:
    ...
    def _write_config(self, file: TextIOWrapper):
      ...
      fields = [
          ...
          ("aggregation_rule", cfg.aggregation_rule, "aggregation strategy"),
          ("data_distribution", cfg.data_distribution, "how data is split across clients"),
          ("dirichlet_alpha", cfg.dirichlet_alpha, "dirichlet concentration parameter"),
